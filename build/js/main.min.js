...
var _customSelect = require("./modules/form-validate/custom-select");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _burger.burgerMenuInit)();
  (0, _initAccordion.initAccordions)();
  (0, _hero.heroSwiper)();
  (0, _slider.initProgramsSwiper)();
  (0, _slider.initNewsSwiper)();
  (0, _news.initNewsBtn)();
  (0, _slider.initReviewsSwiper)();
  (0, _map.initContactsMap)();
...
},{"./modules/accordion/init-accordion":4,"./modules/burger":5,"./modules/form-validate/custom-select":8,"./modules/form-validate/form":9,"./modules/hero":16,"./modules/map":17,"./modules/modals/init-modals":18,"./modules/news":20,"./modules/slider":21,"./utils/ios-vh-fix":24}],3:[function(require,module,exports){
"use strict";
...
exports.burgerMenuInit = void 0;
require("../utils/scroll-lock");
var burgerMenuInit = function burgerMenuInit() {
  var header = document.querySelector('.header');
  var menuList = header.querySelector('.nav');
  var menuToggle = header.querySelector('.header__toggle');
  header.classList.remove('header--no-js');
  menuList.classList.remove('nav--no-js');
  menuToggle.classList.remove('header__toggle--no-js');
  var nav = document.querySelector('.nav');
  var documentKeydownHandler = function documentKeydownHandler(event) {
...
exports.burgerMenuInit = burgerMenuInit;

},{"../utils/scroll-lock":25}],6:[function(require,module,exports){
"use strict";
...
},{"./create-select-markup":7,"./utils":14}],9:[function(require,module,exports){
"use strict";
...
},{"./callback":6,"./init-phone-input":10,"./validator":15}],10:[function(require,module,exports){
"use strict";
...
},{"./matrix":11,"./regular-expression":12,"./render-message":13}],16:[function(require,module,exports){
"use strict";
...
var heroSwiper = function heroSwiper() {
  if (document.querySelector('[data-hero-slider]')) {
    return new _swiper.default('[data-hero-slider]', {
      loop: true,
      speed: 300,
      autoplay: {
        delay: 3000,
...
var _leaflet = require("../../../node_modules/leaflet/dist/leaflet");
var initContactsMap = function initContactsMap() {
  if (document.querySelector('#map')) {
    document.querySelector('#map').querySelector('picture').remove();
    var coordinate = [55.028527396640804, 82.92824989073691];
    var url = 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
    var markerText = document.querySelector('.contacts__item p').innerHTML;
...
},{"../../../node_modules/leaflet/dist/leaflet":1}],18:[function(require,module,exports){
"use strict";
...
},{"./modals":19}],19:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":22,"../../utils/scroll-lock":25}],20:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initNewsBtn = void 0;
var initNewsBtn = function initNewsBtn() {
  if (document.querySelector('.news__button-wrapper')) {
    var ACTIVE__CLASS = 'news__button--active';
    var root = document.querySelector('.news__button-wrapper');
    var tabs = root.querySelectorAll('.news__button');
...
exports.initNewsBtn = initNewsBtn;
...
exports.initReviewsSwiper = exports.initProgramsSwiper = exports.initNewsSwiper = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initProgramsSwiper = function initProgramsSwiper() {
  // eslint-disable-next-line no-undef
  var swiper = new _swiper.default('.programs__slider', {
    loop: false,
    breakpoints: {
      320: {
        allowTouchMove: true,
...
exports.initProgramsSwiper = initProgramsSwiper;
var initNewsSwiper = function initNewsSwiper() {
  var swiper = new _swiper.default('.news__slider', {
    loop: false,
    breakpoints: {
      320: {
        allowTouchMove: true,
...
exports.initNewsSwiper = initNewsSwiper;
var initReviewsSwiper = function initReviewsSwiper() {
...
},{"../vendor/swiper":26}],22:[function(require,module,exports){
"use strict";
